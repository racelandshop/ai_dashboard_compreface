"""AI Facial Dashboard task manager."""
...
class AIFacialDashboardTaskManager:
    """Hacs task manager."""
    ...
    def __init__(self, hacs: AIFacialDashboardBase, hass: HomeAssistant) -> None:
        ...
        self.hacs = hacs
        self.hass = hass
        self.__tasks: dict[str, AIFacialDashboardTask] = {}

    @property
    def tasks(self) -> list[AIFacialDashboardTask]:
    ...
    def get(self, slug: str) -> AIFacialDashboardTask | None:
        """Return a task."""
